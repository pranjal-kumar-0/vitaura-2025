        ...
        <div className="grid grid-cols-1 gap-10 px-4 md:px-16">
          {tshirtData.map((tshirt, index) => (
            <div key={index} className="relative group p-6 bg-gray-800 rounded-lg shadow-lg">
              ...
              <h3 className="text-xl text-white font-semibold mb-2 mt-4">{tshirt.title}</h3>
              ...
              >
                <button className="bg-gradient-to-r from-[#F50062] to-[#b700ba]  py-2 px-4 rounded-lg transition duration-300 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50">
                  Buy Now
                </button>
              </a>
            </div>
