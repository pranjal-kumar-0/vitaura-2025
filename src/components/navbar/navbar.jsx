...
const Navbar = () => {
  return (
    <header className="text-[#fff] body-font bg-black fixed bg-opacity-10 top-0 w-full z-[10000000] ">
      <div className="container mx-auto flex flex-wrap  flex-col md:flex-row items-center z-[10000000] backdrop-blur-lg p-1">
        ...
        <button className="inline-flex items-center bg-gradient-to-r from-[#F50062] to-[#b700ba] border-0 py-2 px-4 focus:outline-none rounded-full text-white mt-4 md:mt-0 font-fluxbox text-[14px]">
